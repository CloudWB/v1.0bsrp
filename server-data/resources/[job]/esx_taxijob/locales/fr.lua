Locales['fr'] = {
  ...
  ['cloakroom_prompt'] = 'appuyez sur ~INPUT_CONTEXT~ pour ouvrir les ~y~vestiaires~s~.',
  ...
  ['spawnpoint_blocked'] = 'il y à un véhicule qui bloque le passage !',
  ...
  ['billing'] = 'facuration',
  ['billing_sent'] = 'la facture à été enregistré !',
