...
Config.MethPrice = false	-- sell price for single, not pooch (black money)
Config.CokePrice = false	-- sell price for single, not pooch (black money)
Config.OpiuPrice = false	-- sell price for single, not pooch (black money)
